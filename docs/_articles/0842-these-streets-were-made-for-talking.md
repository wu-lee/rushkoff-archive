...
notes: 
refs: '[{"text"=>"Talking Street", "original"=>"http://www.talkingstreet.com/les_samplestop.php",
  "archive"=>"http://web.archive.org/web/20180429151548/http://talkingstreet.com/les_samplestop.php",
  "meta"=>{"title"=>"talkingstreet.com - This website is for sale! - self guided tour
  walking tours new york tour lower manhattan tour manhattan tour nyc tour boston
  tour Resources and Information.", "description"=>"This website is for sale! talkingstreet.com
  is your first and best source for all of the information you’re looking for. From
  general topics to more of what you would expect to find here, talkingstreet.com
