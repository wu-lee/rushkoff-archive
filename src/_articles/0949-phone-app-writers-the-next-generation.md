...
refs: '[{"text"=>"Interactive Telecommunications Program", "original"=>"http://itp.nyu.edu/"},
  ...
  "original"=>"http://www.subalerts.com/", "meta"=>{"title"=>"\r\n\tsubalerts.com
  - Registered at Namecheap.com\r\n", "favicon"=>"http://www.subalerts.com/favicon.ico"}},
  {"text"=>"Pantopic", "original"=>"http://www.pantopic.com/", "archive"=>"http://web.archive.org/web/20170919161436/http://pantopic.com/",
  "meta"=>{"favicon"=>"http://www.pantopic.com/favicon.ico"}}, {"text"=>"Cellphedia",
  "original"=>"http://www.cellphedia.com/", "archive"=>"http://web.archive.org/web/20200729163203/http://www.cellphedia.com/",
  "meta"=>{"title"=>"cellphedia.com - This website is for sale! - mobile social software
  Resources and Information.", "description"=>"This website is for sale! cellphedia.com
  is your first and best source for all of the information you’re looking for. From
  general topics to more of what you would expect to find here, cellphedia.com has
  it all. We hope you find what you are searching for!", "favicon"=>"data:image/png;base64,"}},
  {"text"=>"Google SMS", "original"=>"http://www.google.com/sms/", "meta"=>{"title"=>"\n      SMS
  applications and Google account information – Google SMS\n    ", "favicon"=>"http://www.google.com/favicon.ico"}},
  {"text"=>"Wikipedia", "original"=>"http://www.wikipedia.org/", "archive"=>"http://web.archive.org/web/20200801160727/https://www.wikipedia.org/",
  "meta"=>{"title"=>"Wikipedia", "description"=>"Wikipedia is a free online encyclopedia,
  created and edited by volunteers around the world and hosted by the Wikimedia Foundation.",
  "favicon"=>"http://www.wikipedia.org/static/favicon/wikipedia.ico"}}, {"text"=>"AskJeeves",
  "original"=>"http://www.askjeeves.com/", "meta"=>{"title"=>"Ask.com - What''s Your
  Question?", "open_graph"=>{"images"=>[{"url"=>"http://www.ask.com/logo.png"}], "description"=>"Ask.com
  is the #1 question answering service that delivers the best answers from the web
  and real people - all in one place.", "title"=>"Ask.com - What''s Your Question?",
  "url"=>"https://www.ask.com/", "site_name"=>"Ask.com"}, "description"=>"Ask.com
  is the #1 question answering service that delivers the best answers from the web
  and real people - all in one place.", "twitter_card"=>{"card"=>"summary", "site"=>"@AskDotCom"},
  "favicon"=>"http://www.askjeeves.com/favicon.ico"}}, {"text"=>"Neighbornode", "original"=>"http://neighbornode.net/",
  "archive"=>"http://web.archive.org/web/20200311233457/https://neighbornode.net/"},
  {"text"=>"Grafedia", "original"=>"http://www.grafedia.net/", "archive"=>"http://web.archive.org/web/20200729163205/http://www.grafedia.net/",
  "meta"=>{"title"=>"Web Hosting from HostPapa", "favicon"=>"https://www.hostpapa.ca/themes/hostpapaV4/img/favicon.png"}},
  {"text"=>"FoundCity", "original"=>"http://www.foundcity.net/"}, {"text"=>"del.icio.us",
  "original"=>"http://del.icio.us/", "archive"=>"http://web.archive.org/web/20200731141530/http://del.icio.us/"},
  {"text"=>"flickr", "original"=>"http://www.flickr.com/", "meta"=>{"open_graph"=>{"site_name"=>"Flickr",
  "title"=>"Flickr", "type"=>"website", "description"=>"Flickr is almost certainly
  the best online photo management and sharing application in the world. Show off
  your favorite photos and videos to the world, securely and privately show content
  to your friends and family, or blog the photos and videos you take with a cameraphone.",
  "images"=>[{"url"=>"https://farm4.staticflickr.com/3914/15118079089_489aa62638_b.jpg"}]},
  "twitter_card"=>{"apps"=>{"iphone"=>{"name"=>"Flickr", "id"=>"328407587"}}, "site"=>"@flickr",
  "card"=>"summary_large_image", "creator"=>"@flickr", "title"=>"Flickr", "description"=>"Flickr
  is almost certainly the best online photo management and sharing application in
  the world. Show off your favorite photos and videos to the world, securely and privately
  show content to your friends and family, or blog the photos and videos you take
